const Footer = () => {
  return (
    <div className="mx-auto max-w-2xl lg:max-w-4xl px-4 sm:px-6 lg:px-8 pb-4">
      <div className="flex flex-row justify-between border-t border-black/10 dark:border-white/10 py-2">
        <div className="mt-1.5">
          <p className="text-xs font-normal text-chalk">
            <a
              href="https://rutgervanrees.nl"
              className="font-bold text-charcoal dark:text-white hover:text-secondary dark:hover:text-darcondary transition mr-1"
            >
              Rutger van Rees
            </a>
          ...
          <div>
            ...
            >
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-chalk hover:fill-secondary dark:hover:fill-darcondary transition"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
          ...
          <div>
            <a href="https://x.com/rutgervanrees" target="_blank">
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="ml-2 fill-chalk hover:fill-secondary dark:hover:fill-darcondary transition"
              >
